    ...
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between p-6 md:px-12">
        <div className="flex items-center gap-3">
          ...
          <span className="font-display font-semibold text-xl text-foreground">Gideon</span>
        </div>
      ...
      <section className="relative z-10 px-6 pt-12 pb-20 md:pt-20 md:pb-32">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 animate-fade-in-up justify-center lg:justify-start" style={{ animationDelay: '0.4s' }}>
              <Button 
                ...
                className="bg-primary text-primary-foreground px-8 py-6 text-lg shadow-xl shadow-primary/30 hover:bg-primary/90 hover:shadow-primary/40 transition-all"
              >
                Start Learning Free
          ...
          <div className="relative animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            ...
            <img 
              src={gideonHero} 
              alt="Gideon AI Assistant" 
              className="relative rounded-3xl shadow-2xl shadow-primary/20 w-full max-w-lg mx-auto border border-border/50"
            />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div 
                key={feature.title}
                className="group bg-card border border-border rounded-2xl p-6 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 transition-all duration-300 animate-fade-in-up"
          ...
          <div className="mt-20 grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              <img 
                src={robotFeatures} 
                alt="AI Features" 
                className="rounded-3xl shadow-xl border border-border/50 w-full max-w-md mx-auto"
              />
            </div>
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-4">
                {[
                  ...
                  'Uses real-world examples from your field of study',
                  'Remembers context from previous conversations',
                  'Provides quizzes to reinforce understanding'
                ].map((item, i) => (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <img 
                ...
                className="rounded-3xl shadow-xl border border-border/50 w-full max-w-md mx-auto lg:ml-auto"
              />
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 px-6 py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Button 
            size="lg" 
            onClick={() => navigate(user ? '/dashboard' : '/auth')}
            className="bg-primary text-primary-foreground px-10 py-6 text-lg shadow-xl shadow-primary/30 hover:bg-primary/90"
          >
            Get Started Free
            <ArrowRight className="ml-2 h-5 w-5" />
          </Button>
      ...
      <footer className="relative z-10 border-t border-border px-6 py-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-display font-medium text-foreground">Gideon</span>
          </div>
