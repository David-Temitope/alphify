...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Welcome to Alphify — verify your email 🎓',
  invite: "You've been invited to Alphify! 🎉",
  magiclink: 'Your Alphify login link ✨',
  recovery: 'Reset your Alphify password 🔑',
  email_change: 'Confirm your new email ✉️',
  reauthentication: 'Your Alphify verification code 🔐',
}
...
// Configuration
const SITE_NAME = "alphify"
const SENDER_DOMAIN = "notify.alphify.site"
const ROOT_DOMAIN = "alphify.site"
const FROM_DOMAIN = "notify.alphify.site" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://alphify.lovable.app"
